...
def process_args(args) -> None:
    ...
    """
    debug("# Running LLM AD Defense Integration script")
...
def generate_msg(alert: any, options: any) -> any:
    ...
    msg = {
        ...
        "fired_times": alert['rule'].get('firedtimes', 1),
        "groups": alert['rule'].get('groups', []),
        "agent": alert.get('agent', {}),
        "full_alert_data": alert['data'],
